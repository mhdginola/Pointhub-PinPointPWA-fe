    ...
    <div class="relative mt-1">
      <div class="relative">
        ...
        <ComboboxButton class="absolute inset-y-0 right-0 flex items-center pr-2">
          <i class="block i-far-angle-down"></i>
        </ComboboxButton>
...
.options {
  @apply @apply absolute dark:bg-slate-800 dark:border-slate-600 mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 sm:text-sm focus:outline-none z-1;
}
.option {
