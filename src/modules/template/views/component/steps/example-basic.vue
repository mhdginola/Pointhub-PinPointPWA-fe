        ...
        <div class="flex">
          <div class="w-1/4">
            <div class="relative mb-2">
              <div
                class="mx-auto h-10 w-10 flex items-center rounded-full bg-blue-500 text-lg text-white"
              >
            ...
            <div class="text-center text-xs md:text-base">Select Server</div>
          </div>
          ...
          <div class="w-1/4">
            <div class="relative mb-2">
              ...
              >
                ...
                >
                  <div class="w-0 rounded bg-blue-300 py-1" style="width: 100%"></div>
                </div>
              </div>
            ...
            <div class="text-center text-xs md:text-base">Add User</div>
          </div>
          ...
          <div class="w-1/4">
            <div class="relative mb-2">
              ...
              >
                <div
                  class="align-center w-full flex-1 items-center rounded bg-gray-200 align-middle"
                >
                  <div class="w-0 rounded bg-blue-300 py-1" style="width: 33%"></div>
                </div>
              </div>

              <div
                class="mx-auto h-10 w-10 flex items-center border-2 border-gray-200 rounded-full bg-white text-lg text-white"
              >
            ...
            <div class="text-center text-xs md:text-base">Setting</div>
          </div>
          <div class="w-1/4">
            <div class="relative mb-2">
              <div
          ...
          <div class="w-1/4">
            <div class="relative mb-2">
              ...
              >
                <div
                  class="align-center w-full flex-1 items-center rounded bg-gray-200 align-middle"
                >
                  <div class="w-0 rounded bg-blue-300 py-1" style="width: 0%"></div>
                </div>
              </div>
            ...
            <div class="text-center text-xs md:text-base">Finished</div>
          </div>
        </div>
      </div>
    </div>
