...
//     // Mock the geolocation API
//     const mockGeolocation = {
//       getCurrentPosition: ((successCallback: any, errorCallback: (arg0: { message: string; }) => void)=> {
...
//     expect(wrapper.find('.accessGPS').text()).toBe('Error occurred while retrieving geolocation: Geolocation is not supported by this browser.');
//   });
// });
