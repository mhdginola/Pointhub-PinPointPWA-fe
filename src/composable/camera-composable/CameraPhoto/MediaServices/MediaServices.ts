...
import { SUPPORTED_FACING_MODES, FACING_MODES, IMAGE_TYPES, NO_CONSTRAINTS } from './constants'

export class MediaServices {
  static getDataUri(videoElement: any, config: any) {
  ...
  */
  ...
  static getIdealConstraints(idealCameraDevice: any, idealResolution: any) {
  ...
  static getMaxResolutionConstraints(idealCameraDevice = '', numberOfMaxResolutionTry: any) {
    console.warn(
      'getMaxResolutionConstraints() numberOfMaxResolutionTry:',
